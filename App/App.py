...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='nikhil@475$',db='cv')
...
def run():
    ...
    img = Image.open(r'C:\Users\chotu\Downloads\AI-Resume-Analyzer\App\Logo\RESUM.png')
    st.image(img)
    st.sidebar.markdown("# Choose Something...")
    activities = ["User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b>Built with 🤍 by <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: #021659;">Final year students</a></b>' 
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            save_image_path = r'C:\Users\chotu\Downloads\AI-Resume-Analyzer\App\Uploaded_Resumes/'+pdf_file.name
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: grey;">Final year students </a> through 
            <a href="https://www.linkedin.com/in/nikhilgoyal002/" style="text-decoration: none; color: grey;">Dr Bright --(Data Scientist)</a>
        </p>
